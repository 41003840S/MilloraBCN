package com.example.manuel.millorabcn.loginfacebook;
...
import com.example.manuel.millorabcn.MainActivity;
import com.example.manuel.millorabcn.R;
...
public class Login extends Activity {
    ...
    private FacebookCallback<LoginResult> mCallBack = new FacebookCallback<LoginResult>() {
        ...
        public void onSuccess(LoginResult loginResult) {
            ...
            ref = new Firebase("https://millorabcn.firebaseio.com//users");
    ...
    public static void addInfoFirebase(User user){
        final Firebase refUsers = new Firebase("https://millorabcn.firebaseio.com/").child("users").push();
    ...
    public void getFacebookDebugKeyHash(){
        try {
            PackageInfo info = getPackageManager().getPackageInfo(
                    "com.example.manuel.millorabcn.loginfacebook",  // replace with your unique package name
